                                ...
                                <div class="control">
                                    <div class="select">
                                        <select name="categoria">
                                            ...
                                            <option value="fantasmas" @selected($i->categoria == 'fantasmas')>Fantasmas</option>
                                            <option value="demonios" @selected($i->categoria == 'demonios')>Demonios</option>
                                            <option value="monstruos" @selected($i->categoria == 'monstruos')>Monstruos</option>
                                            <option value="creepypastas" @selected($i->categoria == 'creepypastas')>Creepypastas</option>
                                            <option value="leyendas_urbanas" @selected($i->categoria == 'leyendas_urbanas')>Leyendas Urbanas</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
